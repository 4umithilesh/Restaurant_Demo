!function () {
    ...
    function n(n, e) {
        var t = this;
        t.credentials = {email: "", password: ""}, t.onSubmit = function () {
    ...
    function n(n, e) {
        var t = this;
        t.credentials = {name: "", email: "", password: ""}, t.onSubmit = function () {
    ...
    function n(n, e) {
        var t = function (n) {
            ...
            if (r()) {
                var n = o(), t = n.split(".")[1];
                return t = e.atob(t), t = JSON.parse(t), {email: t.email, name: t.name}
            }
        };
        ...
        }, {currentUser: i, saveToken: t, getToken: o, isLoggedIn: r, register: register, login: login, logout: logout}
    }
